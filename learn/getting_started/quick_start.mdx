...
This is a test for the preview links
...
Meilisearch stores data in the form of discrete records, called [documents](/learn/core_concepts/documents). Each document is an object composed of multiple fields, which are pairs of one attribute and one value:
...
If you do not explicitly set the primary key, Meilisearch [infers](/learn/core_concepts/primary_key#meilisearch-guesses-your-primary-key) it from your dataset.
</Capsule>

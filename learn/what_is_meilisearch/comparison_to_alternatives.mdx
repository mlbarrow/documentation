...
|---|:---:|:----:|:---:|:---:|
| API Key Management | ✅ | ✅ | ✅ | ✅ |
| Tenant tokens & multi-tenant indexes | ✅ <br /> [Multitenancy support](/learn/security/tenant_tokens) | ✅ | ✅ | ✅ <br /> Role-based |
...
|  | Meilisearch | Algolia | Typesense | Elasticsearch |
|---|:---:|:----:|:---:|:---:|
| GitHub stars of the main project | 38K | N/A | 14K | 65K |
| Number of contributors on the main project | 150 | N/A | 38 | 1,800 |
| Public Discord/Slack community size | 1600 | N/A | 1,000 | 16K |
...
- [Features](/learn/what_is_meilisearch/overview#features) such as search-as-you-type, typo tolerance, faceting, etc.
